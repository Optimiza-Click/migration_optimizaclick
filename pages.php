...
if(isset($_REQUEST['title_proteccion_datos']))
	create_page($_REQUEST['title_proteccion_datos'], $_REQUEST['slug_proteccion_datos'], 4);
...
function create_page($title, $slug, $type)
{
	...
	switch($type)
	{
		...
		case 4: //PROTECCION DE DATOS
		
			$content = page_proteccion_datos($_REQUEST['name_empresa'], $_REQUEST['address_empresa'], $_REQUEST['cif_empresa'], $_REQUEST['register_empresa'], $_REQUEST['domain_empresa'], $_REQUEST['email_empresa']);
...
//FUNCION PARA CREAR EL CONTENIDO DE LA PAGINA DE AVISO LEGAL A PARTIR DE LAS VARIABLES RECIBIDAS
function page_proteccion_datos($nombre_empresa, $direccion_empresa, $cif_empresa, $registro_mercantil, $dominio_empresa, $correo_empresa)
{
...
<td>'.$nombre_empresa.', '.$direccion_empresa.' '.$cif_empresa.' '.$correo_empresa.'</td>
</tr>
<tr>
<td>Finalidad</td>
<td>Se trata la información que nos facilitan las personas interesadas con el fin de gestionar el envío de la información que nos soliciten, facilitar al interesado ofertas de productos y servicios de su interés y mejorar su experiencia de usuario, pudiendo elaborarse, de ser necesario, un perfil comercial, en base a la información facilitada. No se tomarán decisiones automatizadas en base a dicho perfil.<p></p>
<p>Los datos personales proporcionados se conservarán mientras se mantenga la relación mercantil, y no se solicite su supresión por el interesado.</p></td>
</tr>
<tr>
<td>Legitimación</td>
<td>Se solicita el consentimiento del interesado para el tratamiento de sus datos y la oferta prospectiva de productos y servicios.</td>
</tr>
<tr>
<td>Destinatarios</td>
<td>Los datos personales no se cederán a terceros, salvo en su caso, otras empresas de grupo para fines administrativos internos.</td>
</tr>
<tr>
<td>Derechos</td>
<td>Las personas interesadas tienen derecho a acceder a sus datos personales, así como a solicitar la rectificación de los datos inexactos o, en su caso, solicitar su supresión cuando, los datos ya no sean necesarios para los fines que fueron recogidos. También los interesados en determinadas circunstancias podrán oponerse al tratamiento de sus datos.<p></p>
<p>También tendrá derecho a retirar el consentimiento prestado y a reclamar ante la Autoridad de Control.</p>
<p>Para ejercer sus derechos deberá ponerse en contacto con el Responsable en la dirección que aparece en el primer recuadro, acompañado de copia documento de identidad del interesado.</p></td>
</tr>
</tbody>
</table>
